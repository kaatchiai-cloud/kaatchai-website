...
> **Goal in one line:** move the remaining six feature pipelines (≈9,142 lines — rev-4 corrections applied: PhotoPilot 2,740 (was 3,447); Canvas 840 (27-canvas-state 616 + 28-canvas-consistency 224); `js/29-canvas-render.js` 3,658 stays client-side and is NOT in the extraction surface) to `/v1/*` so the web client never calls Google or fal.ai directly.
