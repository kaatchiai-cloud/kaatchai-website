...
**Target file:** `/Users/praveen/Desktop/stori/cost-estimator.html` (new, single self-contained HTML — no build step, no backend)

**Reference mockup:** `cost-estimator-mock.html` (already in repo — defines the exact visual layout and copy)
...
Single `cost-estimator.html`, vanilla HTML/CSS/JS, no dependencies. Sections in DOM order:
...
1. Skeleton HTML with all sections (no JS yet) — copy structure from `cost-estimator-mock.html`, but use `data-bind`/`data-out` attributes everywhere instead of hardcoded numbers
...
- **Created:** `/Users/praveen/Desktop/stori/cost-estimator.html` (the working tool)
- **Created:** `/Users/praveen/Desktop/stori/cost-estimator-plan.md` (this plan)
- **Reference, not modified:** `/Users/praveen/Desktop/stori/cost-estimator-mock.html`
