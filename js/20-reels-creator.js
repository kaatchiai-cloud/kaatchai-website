...
function renderReelFrame(time) {
  ...
  if (scene) {
    if (scene.isVideo && reelVideoEl) {
      // Video mode: seek to actual video position (segment start + local time)
      ...
      reelVideoEl.currentTime = vidOffset + time;
      // Read current viewport from per-reel settings
