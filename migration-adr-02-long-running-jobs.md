...
- **Lyria BGM** — 30–60 s per migration-details.md L150–154.
- **Gemini grid-gen** — up to 50 s per migration-details.md L141.
...
- Source spec: `/Users/praveen/Desktop/stori/migration-details.md` §Notes L351–356; redesign-plan.md L146 (Kling polling latency, unanchored — verify in P05).
