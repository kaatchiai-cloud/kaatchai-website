...
Override O4 mandates Cloudflare R2 (zero egress fees) for binary storage, replacing the migration-details.md mention of Supabase Storage. Affected binary types:
